...
public class SanPhamChiTietServiceImpl1 {

    List<SanPhamChiTiet1> list = new ArrayList<>();

    public List<SanPhamChiTiet1> getAll2() {
        list.clear();
        try {
    ...
    public SanPhamChiTiet1 getRow2(int row2) {
        return list.get(row2);
    }

    public void Them(SanPhamChiTiet1 spct) {
        try {
    ...
    public void updatect(SanPhamChiTiet1 spct) {
        try {
    ...
    public List<SanPhamChiTiet1> searchByMa(String keywordspct) {
        String sql = " select DISTINCT ct.MaSPCT, TenSanPham, TenThuongHieu, TenChatLieu, TenMauSac, Size, ct.SoLuong \n"
                + "from SanPhamChiTiet ct\n"
                + "join SanPham sp on sp.MaSanpham = ct.MaSanPham\n"
                + "join ThuongHieu th on th.MaThuongHieu=ct.MaThuonghieu\n"
