...
public class SanPhamServiceImpl1 {

    List<SanPham1> list = new ArrayList<>();

    public List<SanPham1> getAll1() {
        list.clear();
        try {
    ...
    public SanPham1 getRow(int row) {
        return list.get(row);
    }

    public void Them(SanPham1 sp) {
        try {
    ...
    public void update(SanPham1 sp) {
        try {
    ...
    public List<SanPham1> searchByMa(String keyword) {
